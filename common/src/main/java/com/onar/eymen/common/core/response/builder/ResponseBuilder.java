package com.onar.eymen.common.core.response.builder;

import static com.onar.eymen.common.core.constant.Keywords.creationKeywords;

import com.onar.eymen.common.core.response.common.Sizable;
...
public class ResponseBuilder {
  ...
  public static <T> SuccessResponse<T> createNotFoundResponse(String message) {
    return new SuccessResponse<>(String.valueOf(HttpStatus.NOT_FOUND.value()), message, 0, null);
  }

  private static String determineSuccessStatusCode(String message) {
    return String.valueOf(
        creationKeywords.stream().map(String::toLowerCase).anyMatch(message.toLowerCase()::contains)
