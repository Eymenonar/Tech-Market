package com.onar.eymen.commonjpa.repository;
...
public interface BaseRepository<T, ID> extends JpaRepository<T, ID> {
  ...
  @Transactional
  @Query(
      "update #{#entityName} e set e.audit.isActive = false, e.audit.deletedAt = current_timestamp, e.audit.deletedBy = ?1 where e.id in :ids")
